...
var EIMZOClient = {
  ...
  idCardIsPLuggedIn: function idCardIsPLuggedIn(success, fail) {
    var items = [];
    var errors = [];
    if (!EIMZOClient.NEW_API2) {
  ...
  createPkcs7: function createPkcs7(id, data, timestamper, success, fail, detached, isDataBase64Encoded) {
    var data64;
